...
for line in tqdm(lines):
    new_line = line.replace("/work/zhangjincheng01/asr/data/test/test_v20220321/","/home/wenet/examples/wenetspeech/s0/data/test/")
    new_lines.append(new_line)

with open("./data/test/wav_docker.scp", "w") as f_out:
